  ...
  c.innerHTML = ` 
    <div class="content-box admin-panel-box" style="text-align:left;margin-top:4px;"> 
      ...
      <div class="content-box-body"> 
        <div id="adminLogin" style="font-size:11px; display: ${window._isAdmin ? 'none' : 'block'}; text-align: center; padding: 10px;"> 
          <button type="button" class="form-btn" onclick="window._googleLogin()" style="background: none; border: none; padding: 0; cursor: pointer; display: inline-block;">
            <img src="https://upload.wikimedia.org/wikipedia/commons/c/c1/Google_%22G%22_logo.svg" alt="Login with Google" style="width: 48px; height: 48px;">
          </button>
        </div> 
